...
export const getStaticProps: GetStaticProps<{ dehydratedState: DehydratedState }> = async function () {
...
export default function Home() {
	...
	return (
		<>
          ...
          {isLoading && new Array(6).fill(null).map((_,index)=><SkeletonCard key={index}/>)}
